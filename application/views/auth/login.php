                            ...
                            <form method="post" action="<?= base_url() ?>login/proses">
                                <div class="card card-login card-hidden">
                                    ...
                                    <?php if ($this->session->flashdata('success_register') != '') : ?>
                                        <p class="category text-center text-success">
                                    ...
                                    <?php if ($this->session->flashdata('error') != '') : ?>
                                        <p class="category text-center text-warning">
                                    ...
                                    <div class="footer text-center">
                                        <button type="submit" class="btn btn-warning btn-simple btn-wd btn-lg">Masuk</button>
                                    </div>
